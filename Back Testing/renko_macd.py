# =============================================================================
# Backtesting strategy - IV : combining renko with MACD
...
tickers = ["NVDA","ON","AVGO","AMAT", "GFS","ASML","LRCX"]



ohlc_intraday = {} # directory with ohlc value for each stock            
key_path = "C:\\Users\\Danish\\Desktop\\Programs\\QT\\AlphaApiKey.txt"
ts = TimeSeries(key=open(key_path,'r').read(), output_format='pandas')

attempt = 0 # initializing passthrough variable
drop = [] # initiali zing list to store tickers whose close price was successfully extracted
